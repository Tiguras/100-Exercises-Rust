...
impl Ticket {
    pub fn new(title: String, description: String, status: String) -> Ticket {
        Self::title_checks(&title);
        Self::description_checks(&description);
        Self::status_checks(&status);
    ...
    fn description_checks(description: &String) {
    ...
    fn status_checks(status: &String) {
